...
**Current release (Xcode):** version **0.2.1**, build **2** — see [CHANGELOG](CHANGELOG.md) for per-build notes
...
1. Grab the latest `QuietClipboard-*.zip` from [Releases](https://github.com/quietapps/QuietClipboard/releases/latest) (tag matches `CFBundleShortVersionString`, currently **0.2.1**)
